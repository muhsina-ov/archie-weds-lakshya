    ...
    >
      ...
      >
        <motion.div
          ...
          className="mb-3 rounded-full bg-parchment/90 p-2 border border-gold/50 shadow-md"
        >
          <img src={jainSymbol} alt="Jain Emblem" className="h-10 w-10 object-contain mix-blend-multiply" />
        </motion.div>
        ...
        <div className="relative mt-6 flex h-36 w-36 items-center justify-center">
          ...
          <motion.span
            ...
            className="absolute inset-3 rounded-full border border-gold/70 bg-parchment/8 backdrop-blur-[2px]"
          />
          <motion.span
            animate={{ scale: [1, 1.16, 1], opacity: [0.35, 0, 0.35] }}
            transition={{ duration: 3.4, repeat: Infinity, ease: "easeInOut" }}
            className="absolute inset-3 rounded-full border border-gold"
          />
          <motion.span
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="mt-4 font-display text-lg tracking-[0.25em] text-gold space-y-1"
        >
          <p>14 . 11 . 2026</p>
          <p>15 . 11 . 2026</p>
        </motion.div>
